...
evaluation_samples_number = round(len(paths) / (distribution + 1))
training_samples_number = round(evaluation_samples_number * distribution)

assert training_samples_number + evaluation_samples_number == (len(paths) + 1)
...
# print(len(train_set), training_samples_number)
assert (len(train_set) + 1) == training_samples_number
